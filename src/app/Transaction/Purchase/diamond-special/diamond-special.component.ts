...
@Component({
  selector: 'app-diamond-special',
  templateUrl: './diamond-special.component.html',
  styleUrls: ['./diamond-special.component.css']
})
export class DiamondSpecialComponent implements OnInit {
  ...
  constructor(
    ...
    private _mdr: MatDialogRef<DiamondSpecialComponent>,
    ...
    this.categoryarr = [{ code: 'SCDNAT', name: 'Natural' }, { code: 'SCDCVD', name: 'CVD' }]
