...
@Component({
  selector: 'app-precious-colorstone',
  templateUrl: './precious-colorstone.component.html',
  styleUrls: ['./precious-colorstone.component.css']
})
export class PreciousColorstoneComponent implements OnInit {
  ...
  constructor(
    ...
    private _mdr: MatDialogRef<PreciousColorstoneComponent>,
    ...
    if (this.Category == "CSSEMI") {
      this.HEADERNAME = 'Purchase In: Loose Coloured Stone - Semi Precious'
    } else if (this.Category == "CSPREC") {
      this.HEADERNAME = 'Purchase In: Loose Coloured Stone - Precious'
    }
  ...
  Save() {
    ...
    let resultobj = {
      ...
      Size: 0,
      MM: 0,
      Origin: this.Origin.value.toString(),
