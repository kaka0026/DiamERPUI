...
@Component({
  selector: 'app-diamond-smal',
  templateUrl: './diamond-smal.component.html',
  styleUrls: ['./diamond-smal.component.css']
})
export class DiamondSmalComponent implements OnInit {
  ...
  constructor(
    ...
    private _mdr: MatDialogRef<DiamondSmalComponent>,
    ...
    this.categoryarr = [{ code: 'SRDNAT', name: 'Natural' }, { code: 'SRDCVD', name: 'CVD' }]
