...
@Component({
  selector: 'app-colourd-stone',
  templateUrl: './colourd-stone.component.html',
  styleUrls: ['./colourd-stone.component.css']
})
export class ColourdStoneComponent implements OnInit {
  ...
  constructor(
    ...
    private _mdr: MatDialogRef<ColourdStoneComponent>,
